...
const Name=useRef();
  function handleSubmit(e) {
    e.preventDefault();
    let variables= {msg: msg.current.value, Name: Name.current.value,
         Subject: Subject.current.value,reciever:props.Email,
  ...
  return (
    <Popup
      trigger={<Button  className="mb-2 mt-2" style={{marginRight:"60%"}}> Send Email</Button>}
          ...
          <Card.Body>
            ...
            <Form.Group id="Subject">
              ...
              <Form.Group id="msg">
                ...
                <Form.Control as="textarea"ref={msg} rows={5} name="msg" style={{width:"100%"}}></Form.Control>
              </Form.Group>
